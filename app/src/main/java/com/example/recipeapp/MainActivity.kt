...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        savebtn.setOnClickListener {
            var f = RecipeDetails.RecipeDetailsItem(title.text.toString(), author.text.toString(),
    ...
    fun addReceipe(userData: RecipeDetails.RecipeDetailsItem, onResult: (RecipeDetails?) -> Unit) {
